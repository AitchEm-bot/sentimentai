export interface WebSocketMessage {
  type: 'connected' | 'recording_started' | 'speech_started' | 'processing' | 'transcript' | 'audio' | 'audio_start' | 'audio_end' | 'interrupted' | 'error' | 'pong' | 'user_transcript' | 'response_complete';
  sessionId?: string;
  message?: string;
  userText?: string;
  aiText?: string;
