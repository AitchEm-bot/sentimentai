...
export default function DemoShowcaseIntl() {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            <span className="text-gray-900">{t("titlePart1")}</span>
            <br />
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            <h3 className="text-2xl font-bold mb-6 text-gray-900">{t("customerCallAudio")}</h3>
            ...
            <div className="mb-6">
              <span className={`inline-block px-4 py-2 rounded-lg text-sm font-medium ${currentDemo.sentimentBg} ${currentDemo.sentimentText} border ${currentDemo.sentimentBorder}`}>
                {t("sentiment")}: {currentDemo.sentiment} ({currentDemo.sentimentScore}%)
              </span>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-6">
              ...
              <div className="flex justify-between text-xs text-gray-500">
                <span>{t("audioExcerpt")}</span>
                <span>{t("fullCall")}: {currentDemo.duration}</span>
              </div>
            </div>
            ...
            <div className="mb-6 bg-white rounded-xl p-4 border border-gray-200">
              <div className="flex items-center justify-between mb-2">
                <h4 className="text-sm font-semibold text-gray-700">{t("agentPerformance")}</h4>
              ...
              <div className="flex items-center gap-2">
                <span className={`inline-block px-2 py-1 rounded text-xs font-medium ${currentDemo.handledWell ? 'bg-green-100 text-green-700' : 'bg-orange-100 text-orange-700'}`}>
                  {currentDemo.handledWell ? t("handledWell") : t("needsImprovement")}
                </span>
              </div>
            </div>
            ...
            {/* Detected Emotions */}
            <div className="mb-6">
              <h4 className="text-sm font-semibold text-gray-700 mb-3">{t("detectedEmotions")}</h4>
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl border border-gray-200 p-8 shadow-lg"
          >
            <h3 className="text-2xl font-bold mb-6 text-gray-900">{t("aiAnalysisResults")}</h3>

            {/* Summary */}
            <div className="mb-6">
              <h4 className="text-sm font-semibold text-gray-700 mb-2">{t("summary")}</h4>
            ...
            {/* Key Points */}
            <div className="mb-6">
              <h4 className="text-sm font-semibold text-gray-700 mb-3">{t("keyPoints")}</h4>
            ...
            {/* Recommended Actions */}
            <div>
              <h4 className="text-sm font-semibold text-gray-700 mb-3">{t("recommendedActions")}</h4>
              <ul className="space-y-2">
